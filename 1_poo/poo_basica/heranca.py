"""
Herança permite criar uma nova classe a partir de uma classe existente,
reutilizando e especializandoseus atributos e métodos.
...
Comportamento
Sobrescrita (override): subclasse redefine um método herdado, permitindo comportamentos diferentes 
